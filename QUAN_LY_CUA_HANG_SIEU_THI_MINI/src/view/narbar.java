...
public class narbar extends javax.swing.JFrame {
    //public QLMTModel model;
    private String userName;
    Color DefaultColor, ClickedColor;
    public narbar(String user) throws UnsupportedLookAndFeelException {
    ...
    private void initComponents() {
        ...
        NavbarMenu.add(KhuyenMai, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, 170, 40));
        ...
        NavbarMenu.add(SanPham, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 200, 170, 40));
        ...
        NavbarMenu.add(BanHang, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 170, 40));
        ...
        NavbarMenu.add(NhanVien, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, 170, 40));
        ...
        NavbarMenu.add(KhachHang, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, 170, 40));
        ...
        NavbarMenu.add(NhapHang, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 320, 170, 40));
        ...
        NavbarMenu.add(HoaDon, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 170, 40));
        ...
        NavbarMenu.add(PhieuNhapHang, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 360, 170, 40));
        ...
        NavbarMenu.add(TaiKhoan, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 480, 170, 40));
        ...
        NavbarMenu.add(DangXuat, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 520, 170, 40));
        ...
        NavbarMenu.add(ThongKe1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 440, 170, 40));
        ...
        NavbarMenu.add(NhaCungCap1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 400, 170, 40));
